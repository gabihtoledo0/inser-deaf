...
class UserCardDao {
  static const String tableSql =
      'CREATE TABLE $_tableUserCard($_id INTEGER PRIMARY KEY AUTOINCREMENT NOT NULL, $_nome varchar(100), $_titulo varchar(100), $_telefone varchar(14) $_horario varchar(10) not null, $_data Date not null, $_cep varchar(9) not null;';
