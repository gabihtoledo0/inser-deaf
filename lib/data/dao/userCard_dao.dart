...
class UserCardDao {
  static const String tableSql =
      'CREATE TABLE $_tableUserCard($_id INTEGER PRIMARY KEY AUTOINCREMENT NOT NULL, $_nome varchar(100), $_telefone varchar(14) $_horario varchar(10) not null, $_data Date not null, $_cep varchar(9) not null;';
  ...
  Future<UserCard> getUserCard(int id) async {
    ...
    List<Map> maps = await db.query(
      _tableUserCard,
      columns: [_id, _nome, _telefone, _horario, _data, _cep],
      where: "$_id = ?",
      whereArgs: [id],
    );
